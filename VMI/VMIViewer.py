...
#            self.refTOF=self.normTOF
    ...
    def StreamOnOff(self):
        ...
        if self.checkbox1.checkState()==2:
            ...
            try:
                print 'bp0'
                sharedmem=mmap.mmap(0, ctypes.sizeof(ctypes.c_int8*400*400),'SharedDisplayMemory')
                print 'bp1'
                ...
                print data
                tmp=data[:-4000]
                self.activeimg=tmp.reshape((400,400))
    ...
    def UpdateStream(self,sharedmemory):
        ...
        print 'bpp2'
        self.activeimg=np.reshape(data[:-4000],(400,400))
        print 'bpp3'
        self.updatePlot
        print 'bpp4'
        self.updateIsocurve
